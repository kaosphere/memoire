...
Les électrodes étant alimentées en +5V/-5V, et le PIC32 fonctionnant à 3.3V, il est nécessaire d’adapter les signaux des électrodes de +5V/-5V à 0/3V. Pour ce faire, deux amplificateurs opérationnels sont nécessaires. Un montage inverseur ayant un gain de 1/3 ainsi qu’un montage sommateur inverseur afin que le signal soit compris dans des voltages positifs. %TODO détailler plus les étages d'amplis op
