...
\datesoutenance{``23 Septembre 2013''}

\datedepot{``01 Octobre 2013''}
...
\examinexterne{M.}{Maxime Raison}{Professeur à l'école Polytechnique de Montréal}{}

%\jury{Mme.}{Maxime Raison}{Professeur à l'école Polytechnique de Montréal}{}
...
% ABSTRACT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}{utilisation de signaux électromyographiques pour le contrôle d'un bras robotique pour usagers de fauteuils roulants motorisés.}{Kinova, JACO, EMG control, real time, spinal cord injury }
...
\item [$Coeff_{angle}$] Coefficient de normalisation de l'efficacité en fonction de l'angle maximum atteint par le sujet
\item [$Coeff_{vitesse}$] Coefficient de normalisation de l'efficacité en fonction de la vitesse maximum atteinte par le sujet
\item [$Eff_{globale}$] Efficacité globale pour un sujet
\item [$ms$] milliseconde
\item [$Hz$] Hertz
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.8\linewidth]{Figures/emg.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.6\linewidth]{Figures/muscles2.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.9\linewidth]{Figures/archiMatTot.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.6\linewidth]{Figures/circuitadaptB.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.95\linewidth]{Figures/cablagePic.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.8\linewidth]{Figures/montage.jpg}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.95\linewidth]{Figures/tke.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.8\linewidth]{Figures/tkeSeuil3.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.7\linewidth]{Figures/onsetSansVote.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.95\linewidth]{Figures/onsetAvecVote.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.7\linewidth]{Figures/filtre.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.6\linewidth]{Figures/adc2.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.9\linewidth]{Figures/mono.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.95\linewidth]{Figures/validExAngle.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.95\linewidth]{Figures/validExVit.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.95\linewidth]{Figures/validExEMG.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.95\linewidth]{Figures/validExOnsetB.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.9\linewidth]{Figures/onset.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.9\linewidth]{Figures/montageglobal.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.6\linewidth] {Figures/montage.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.7\linewidth] {Figures/mapS005Fon.png}
	}
