...
Pour des raisons économiques et pratique, le PIC32, comme présenté sur la figure \ref{fig:pic32} %TODO mettre photos pic32
...
Une fois les initialisations effectuée, le programme entre dans une boucle infinie qui constitue la colonne vertébrale du programme. Les actions réalisée par cette boucle sont présentée par la figure \ref{fig:mainloop}.
...
Le logiciel de monitorage des signaux est un programme basé autour de l'interface graphique réalisée grace à la librairie Qt. Le diagramme UML du programme est présenté par la figure \ref{fig:uml}.
