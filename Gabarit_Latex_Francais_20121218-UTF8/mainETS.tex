...
Le premier couple de barres montre l'efficacité moyenne sur tous les angles du système allant de 10 degrés à 80 degrés. Celle-ci atteint une valeur de xxx pour le système avec filtrage et de yyy pour le système sans filtrage. 

Le deuxième couple de barres montre l'efficacité moyenne du système sur les angles allant de 40 degrés à 80 degrés. Cette efficacité est de xxx pour le système avec filtrage et de yyy pour le système sans filtrage. 

De la même manière les trois couples de barres montrent respectivement les efficacités pour les angles allant de 50 à 80 degrés, de 60 à 80 degrés et de 70 et 80 degrés. 

Enfin le dernier couple de barres montre l'efficacité moyenne du système pour les angles de 10 à 30 degrés. Cette valeur est de xxx pour le système avec filtrage et de yyy pour le système sans filtrage.
...
Le premier diagramme présente ainsi la répartition de l'efficacité globale avec une médiane à xxx et une donnée aberrante correspondant au sujet S004. L'efficacité globale du système sans filtrage présente une médiane à yyy avec une données aberrante principale à une valeur de zzz correspondant au sujet S002.
...
Le deuxième diagramme présente la répartition des efficacités pour les angles de 40 à 80 degrés. Avec filtrage du signal, la médiane de l'efficacité est obtenue à xxx, tandis que celle sans filtrage est obtenue à yyy. Sans le filtrage on observe toujours la donnée aberrante du sujet S002 aux alentours de $0.9$. 

Le troisième diagramme présente la répartition des efficacités pour les angles allant de 50 à 80 degrés. La médianne de cette efficacité est obtenue à xxx avec filtrage et à yyy sans le filtrage. 
