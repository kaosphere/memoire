...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.8\linewidth]{Figures/onset.png}
	}
...
\begin{figure}
	\centering
	\fbox{
		\includegraphics[width=0.8\linewidth]{Figures/montageglobal.png}
	}
...
La figure \ref{fig:chronoonset} montre le chronogramme enregistré pour la détection d'activité des quatre canaux EMG. Le temps de calcul nécessaire à la détection d'activité sur les quatre canaux est de 1.23 ms.

%TODO : rajouter figure chronoonset

La même opération a été également réalisée pour mesurer le temps de calcul nécessaire au filtrage d'un seul canal EMG. Le chronogramme enregistré pour ce faire est présenté par la figure \ref{fig:chronofiltre}. Le temps de calcul mesuré est de 3.58 ms.

%TODO : rajouter figure chronofiltre
